...
if ($mysqli) {
    ...
    switch ($userSelection):
        ...
        case $DeleteAQuizzes:
            ...
            header("Location: http://csis.svsu.edu/~jasopczy/cis355/TeamProject/Quizzes.php");
            break;
        case $SelectAQuizzes:
            $_SESSION['QuizID'] = $_POST['uid'];
            header("Location: http://csis.svsu.edu/~jasopczy/cis355/TeamProject/Questions.php");
            break;
        ...
        case $QuizzesExecuteUpdate:
            ...
            break;
        case $BackToLessons:
            header("Location: http://csis.svsu.edu/~jasopczy/cis355/TeamProject/Lessons.php");
            break;
        case $BackToQuizzes:
            header("Location: http://csis.svsu.edu/~jasopczy/cis355/TeamProject/Quizzes.php");
            break;
        case $PreviousReview:
            $_SESSION['QuizID'] = $_POST['uid'];
            header("Location: http://csis.svsu.edu/~jasopczy/cis355/TeamProject//newQuizzesReview.php");
            break;
        case $WriteAReview:
            $_SESSION['QuizID'] = $_POST['uid'];
            header("Location: http://csis.svsu.edu/~jasopczy/cis355/TeamProject/newQuizzesReview.php");
